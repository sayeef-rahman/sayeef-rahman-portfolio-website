            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:mx-20 mt-10'>
                <div className="card w-96 bg-base-100 shadow-xl rounded-sm">
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-2xl">Hand Tools</h2>
                        ...
                        <div className="card-actions justify-center">
                            <button className="btn btn-primary rounded-none w-1/2" onClick={() => handTools()}>See Details</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-xl rounded-sm">
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-2xl">Toffpark Warehouse</h2>
                        ...
                        <div className="card-actions justify-center">
                            <button className="btn btn-primary rounded-none w-1/2" onClick={() => toffparkWarehouse()}>See Details</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-xl rounded-sm">
                    ...
                    <div className="card-body bg-slate-100">
                        <h2 className="card-title text-2xl">Pics Diary</h2>
                        ...
                        <div className="card-actions justify-center">
                            <button className="btn btn-primary rounded-none w-1/2" onClick={() => picsDiary()}>See Details</button>
                        </div>
                    </div>
                </div>
            </div>
